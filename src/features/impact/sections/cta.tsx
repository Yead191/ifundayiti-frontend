...
import { IMPACT_CTA } from "@/data/impact-page";
          ...
          <div className="relative grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:col-span-5 lg:flex-col">
              <Button asChild size="lg" variant="secondary" className="rounded-xl">
                <Link href={IMPACT_CTA.primary.href}>
                  {IMPACT_CTA.primary.label}
              ...
              >
                <Link href={IMPACT_CTA.secondary.href}>
                  {IMPACT_CTA.secondary.label}
                </Link>
              </Button>
            </div>
          </div>
