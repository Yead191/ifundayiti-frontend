...
### 5. 🛍️ Ethical Impact Shop (`/shop`)

- Premium merchandise, apparel, and cultural goods where 100% of proceeds fuel the Program Fund.
- Color & size variant selection, interactive shopping bag drawer, and guest or member checkout.

### 6. 💳 Stripe Payment & Donation Gateway

- Embedded, PCI-compliant Stripe checkout for direct donations and merchandise orders.
- Dynamic currency formatting and automated confirmation emails.

### 7. 🎟️ Community Events & Pitch Nights (`/events`)

- Calendar feeds and month grids for virtual (Zoom) and in-person (New York, Port-au-Prince) events.
- Transparent notice that all event ticket gifts flow directly into quarterly micro-grant capital.
